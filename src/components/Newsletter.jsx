    ...
    >
      <div
        style={{
          position: 'absolute',
          inset: 0,
          backgroundImage: 'radial-gradient(rgba(188,116,78,0.22) 1px, transparent 1px)',
          backgroundSize: '32px 32px',
          opacity: 0.5,
          maskImage: 'radial-gradient(ellipse 800px 400px at 20% 50%, black, transparent 70%)',
          pointerEvents: 'none',
        }}
      />
      <motion.div
        ...
        style={{
          ...
          height: 500,
          borderRadius: '50%',
          background: 'conic-gradient(from 0deg, rgba(216,154,92,0.08), transparent 60%, rgba(188,116,78,0.10))',
          filter: 'blur(10px)',
          pointerEvents: 'none',
        }}
      />
      ...
      >
        ...
        <motion.div
          ...
          style={{
            ...
            borderRadius: '18px',
            padding: '3.5rem',
            boxShadow: 'var(--shadow-xl), 0 30px 60px -20px rgba(140,70,40,0.18)',
            position: 'relative',
            overflow: 'hidden',
          }}
        >
            ...
            {status === 'success' ? (
              ...
              >
                ...
                <motion.button
                  ...
                  style={{
                    width: '100%',
                    background: 'linear-gradient(135deg, var(--accent-amber) 0%, var(--accent-primary) 50%, var(--accent-deep) 100%)',
                    color: '#fff',
                    border: 'none',
                    padding: '1rem',
                    borderRadius: '6px',
